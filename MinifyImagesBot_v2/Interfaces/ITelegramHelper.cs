...
internal interface ITelegramHelper
{
    ...
    Task<Message?> SendKeyboardMessage(string? message, InlineKeyboardMarkup markup, bool replyMessage = false);
    ...
    InlineKeyboardMarkup? GetKeyboard(KeyboardTypesEnum type);
}